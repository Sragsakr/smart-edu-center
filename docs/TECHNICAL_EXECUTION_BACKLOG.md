...
- [x] `PLATFORM-ADMIN-001-07` Dashboard shell موحّدة بقائمة جانبية متجاوبة، تمييز للمسار الحالي، وتنقل موبايل قابل للوصول.
- [x] `PLATFORM-ADMIN-001-08` سجل تدقيق منظم ومجمّع/قابل للفلترة حسب Tenant، مع هوية واضحة وتفاصيل كاملة قابلة للتوسيع.
